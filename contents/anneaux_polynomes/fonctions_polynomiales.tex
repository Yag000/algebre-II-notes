...
\begin{definition}[Polynôme composé]
	...
	On appelle le polynôme composé de $P$ par $Q$ le polynôme $$P(Q) = a_nQ^n + a_{n-1}Q^{n-1} + \dots + a_0$$
...
\begin{definition}[Racine d'un polynôme]
	Soit $P \in A[X]$. On dit que $a \in A$ est une racine de $P$ si et seulement si $P(a) = 0$.
\end{definition}
