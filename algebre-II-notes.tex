...
\begin{proof}
	...
	Ainsi, $\operatorname{deg}(P)=n$ et $\operatorname{deg}(Q)=m$. Le terme de plus haut degré dans $P Q$ vient de $a_n X^n \cdot b_m X^m=a_n \cdot b_m X^{n+m}$.
	Par conséquent, $\operatorname{deg}(P Q) \leq n+m=\operatorname{deg}(P)+\operatorname{deg}(Q)$.

	Si A est intègre, alors $a_n b_m \neq 0$ si $a_n \neq 0$ et $b_m \neq 0$. Ainsi:
	$$
		\operatorname{deg}(P Q)=n+m=\operatorname{deg}(P)+\operatorname{deg}(Q).
	$$
\end{proof}
...
\begin{proof}
	...
	$\Leftarrow$ Si $A$ est intègre, alors pour tous $P, Q \in A[X]$, on a $\operatorname{deg}(P Q)=\operatorname{deg}(P)+\operatorname{deg}(Q)$.
	Puisque l'anneau $A$ est commutatif et non trivial (le cas trivial étant évident), il en est de même de $A[X]$.
	Soient $P, Q \in A[X]$ non nuls. on a donc $\operatorname{deg}(P) \geqslant 0$ et $\operatorname{deg}(Q) \geqslant 0$.
	Mais alors, on a :
	$$
		\operatorname{deg}(P Q)=\operatorname{deg}(P)+\operatorname{deg}(Q) \geqslant 0,
	$$
